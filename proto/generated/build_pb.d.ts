 ...
 */
export declare const file_build: GenFile;

/**
 * @generated from message blaze_query.License
 */
export declare type License = Message<"blaze_query.License"> & {
  /**
 ...
 */
export declare type StringDictEntry = Message<"blaze_query.StringDictEntry"> & {
  /**
 ...
 */
export declare type LabelDictUnaryEntry = Message<"blaze_query.LabelDictUnaryEntry"> & {
  /**
   * @generated from field: required string key = 1;
   */
  key: string;
 ...
 */
export declare type LabelListDictEntry = Message<"blaze_query.LabelListDictEntry"> & {
  /**
   * @generated from field: required string key = 1;
   */
  key: string;
 ...
 */
export declare type LabelKeyedStringDictEntry = Message<"blaze_query.LabelKeyedStringDictEntry"> & {
  /**
   * @generated from field: required string key = 1;
   */
  key: string;
 ...
 */
export declare type StringListDictEntry = Message<"blaze_query.StringListDictEntry"> & {
  /**
   * @generated from field: required string key = 1;
   */
  key: string;
 ...
 */
export declare type FilesetEntry = Message<"blaze_query.FilesetEntry"> & {
  /**
 ...
 */
export declare type Attribute = Message<"blaze_query.Attribute"> & {
  /**
 ...
 */
export declare type Attribute_SelectorEntry = Message<"blaze_query.Attribute.SelectorEntry"> & {
  /**
 ...
 */
export declare type Attribute_Selector = Message<"blaze_query.Attribute.Selector"> & {
  /**
 ...
 */
export declare type Attribute_SelectorList = Message<"blaze_query.Attribute.SelectorList"> & {
  /**
 ...
 */
export declare type Rule = Message<"blaze_query.Rule"> & {
  /**
 ...
 */
export declare type ConfiguredRuleInput = Message<"blaze_query.ConfiguredRuleInput"> & {
  /**
   * Dep's target label.
   *
   * @generated from field: optional string label = 1;
 ...
 */
export declare type RuleSummary = Message<"blaze_query.RuleSummary"> & {
  /**
 ...
 */
export declare type PackageGroup = Message<"blaze_query.PackageGroup"> & {
  /**
 ...
 */
export declare type EnvironmentGroup = Message<"blaze_query.EnvironmentGroup"> & {
  /**
 ...
 */
export declare type SourceFile = Message<"blaze_query.SourceFile"> & {
  /**
 ...
 */
export declare type GeneratedFile = Message<"blaze_query.GeneratedFile"> & {
  /**
 ...
 */
export declare type Target = Message<"blaze_query.Target"> & {
  /**
 ...
 */
export declare type QueryResult = Message<"blaze_query.QueryResult"> & {
  /**
 ...
 */
export declare type AllowedRuleClassInfo = Message<"blaze_query.AllowedRuleClassInfo"> & {
  /**
 ...
 */
export declare type AttributeDefinition = Message<"blaze_query.AttributeDefinition"> & {
  /**
   * e.g. "name", "srcs"
   *
   * @generated from field: required string name = 1;
 ...
 */
export declare type AttributeValue = Message<"blaze_query.AttributeValue"> & {
  /**
   * type=int|tristate
   *
 ...
 */
export declare type AttributeValue_DictEntry = Message<"blaze_query.AttributeValue.DictEntry"> & {
  /**
   * @generated from field: required string key = 1;
   */
  key: string;
 ...
 */
export declare type RuleDefinition = Message<"blaze_query.RuleDefinition"> & {
  /**
   * @generated from field: required string name = 1;
   */
  name: string;
 ...
 */
export declare type BuildLanguage = Message<"blaze_query.BuildLanguage"> & {
  /**
