 ...
 */
export const file_stardoc_output: GenFile = /*@__PURE__*/
 ...
 */
export type ModuleInfo = Message<"stardoc_output.ModuleInfo"> & {
  /**
 ...
 */
export type RuleInfo = Message<"stardoc_output.RuleInfo"> & {
  /**
 ...
 */
export type MacroInfo = Message<"stardoc_output.MacroInfo"> & {
  /**
 ...
 */
export const MacroInfoSchema: GenMessage<MacroInfo> = /*@__PURE__*/
 ...
 */
export type AttributeInfo = Message<"stardoc_output.AttributeInfo"> & {
  /**
 ...
 */
export type ProviderNameGroup = Message<"stardoc_output.ProviderNameGroup"> & {
  /**
 ...
 */
export const ProviderNameGroupSchema: GenMessage<ProviderNameGroup> = /*@__PURE__*/
 ...
 */
export type StarlarkFunctionInfo = Message<"stardoc_output.StarlarkFunctionInfo"> & {
  /**
 ...
 */
export const StarlarkFunctionInfoSchema: GenMessage<StarlarkFunctionInfo> = /*@__PURE__*/
 ...
 */
export type FunctionParamInfo = Message<"stardoc_output.FunctionParamInfo"> & {
  /**
 ...
 */
export const FunctionParamInfoSchema: GenMessage<FunctionParamInfo> = /*@__PURE__*/
  messageDesc(file_stardoc_output, 6);

/**
 * @generated from message stardoc_output.FunctionReturnInfo
 */
export type FunctionReturnInfo = Message<"stardoc_output.FunctionReturnInfo"> & {
  /**
 ...
 */
export const FunctionReturnInfoSchema: GenMessage<FunctionReturnInfo> = /*@__PURE__*/
  messageDesc(file_stardoc_output, 7);

/**
 * @generated from message stardoc_output.FunctionDeprecationInfo
 */
export type FunctionDeprecationInfo = Message<"stardoc_output.FunctionDeprecationInfo"> & {
  /**
 ...
 */
export const FunctionDeprecationInfoSchema: GenMessage<FunctionDeprecationInfo> = /*@__PURE__*/
 ...
 */
export type ProviderFieldInfo = Message<"stardoc_output.ProviderFieldInfo"> & {
  /**
 ...
 */
export const ProviderFieldInfoSchema: GenMessage<ProviderFieldInfo> = /*@__PURE__*/
 ...
 */
export type ProviderInfo = Message<"stardoc_output.ProviderInfo"> & {
  /**
 ...
 */
export type AspectInfo = Message<"stardoc_output.AspectInfo"> & {
  /**
 ...
 */
export const AspectInfoSchema: GenMessage<AspectInfo> = /*@__PURE__*/
 ...
 */
export type ModuleExtensionInfo = Message<"stardoc_output.ModuleExtensionInfo"> & {
  /**
 ...
 */
export const ModuleExtensionInfoSchema: GenMessage<ModuleExtensionInfo> = /*@__PURE__*/
 ...
 */
export type ModuleExtensionTagClassInfo = Message<"stardoc_output.ModuleExtensionTagClassInfo"> & {
  /**
 ...
 */
export const ModuleExtensionTagClassInfoSchema: GenMessage<ModuleExtensionTagClassInfo> = /*@__PURE__*/
 ...
 */
export type RepositoryRuleInfo = Message<"stardoc_output.RepositoryRuleInfo"> & {
  /**
 ...
 */
export const RepositoryRuleInfoSchema: GenMessage<RepositoryRuleInfo> = /*@__PURE__*/
 ...
 */
export type OriginKey = Message<"stardoc_output.OriginKey"> & {
  /**
 ...
 */
export const OriginKeySchema: GenMessage<OriginKey> = /*@__PURE__*/
 ...
 */
export const FunctionParamRoleSchema: GenEnum<FunctionParamRole> = /*@__PURE__*/
